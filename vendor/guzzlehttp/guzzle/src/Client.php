...
use AltaPay\vendor\GuzzleHttp\Cookie\CookieJar;
use AltaPay\vendor\GuzzleHttp\Exception\GuzzleException;
use AltaPay\vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \AltaPay\vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
